...
![alt text](https://img.genmin.icu/p/phpblog/image-1.png)

它会告诉我们密码以及登录链接，点击 `点我登录` 即可跳转到登录界面并输入账号密码即可

![alt text](https://img.genmin.icu/p/phpblog/image-2.png)

### Dns 配置

进入到入口，点击你设置的域名，比如我这里就是 `888880.top`

![alt text](https://img.genmin.icu/p/phpblog/image-4.png)

记好这串 IP 地址: 

![alt text](https://img.genmin.icu/p/phpblog/image-5.png)

我分配到的 IP 地址为: 74.50.84.66

随后到你的域名注册/服务商，配置 DNS记录: 

![alt text](https://img.genmin.icu/p/phpblog/image-6.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-7.png)

当一切配置完成的时候，用浏览器打开你的域名，理论上就可以看到初始页面了！

![alt text](https://img.genmin.icu/p/phpblog/image-8.png)

### 安装 WordPress

还是回到刚才的界面，点击左上角的 `Quick Install App`

![alt text](https://img.genmin.icu/p/phpblog/image-9.png)

向下翻一下，找到 `WordPress`，点击其 `Setup`

![alt text](https://img.genmin.icu/p/phpblog/image-10.png)

看到那些输入栏了吗？不要害怕，很简单，我来一个个解释一下

![alt text](https://img.genmin.icu/p/phpblog/image-11.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-12.png)
...
![](https://img.genmin.icu/p/phpblog/image-13.png)

默认应该会有一个数据库了，我的是 `qbqupihi_28521`

点击你所拥有的数据库，在这里设置一个密码，并记好用户名

![alt text](https://img.genmin.icu/p/phpblog/image-14.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-15.png)

点击 `继续前往xxx.xxx（不安全）` 即可

#### 选择语言

![](https://img.genmin.icu/p/phpblog/image-16.png)

看这个博客的一般都是中国人吧，当然要划到最下面选择中文啦

#### 现在就开始

![alt text](https://img.genmin.icu/p/phpblog/image-17.png)

现在就开始！

#### 填写数据库

![alt text](https://img.genmin.icu/p/phpblog/image-18.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-19.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-20.png)

这也是 `安装 WordPress` 那一步的信息，填入即可，最后一个搜索引擎不需要勾选，填写完点击 `安装 WordPress` 即可

![alt text](https://img.genmin.icu/p/phpblog/image-21.png)

这样就差不多了

#### 安装完成

![alt text](https://img.genmin.icu/p/phpblog/image-22.png)

这样就算完成了！恭喜你，你已经迈出了重要的一步

再次从浏览器访问你的域名，应该可以看见预设的界面，即代表安装成功:

![alt text](https://img.genmin.icu/p/phpblog/image-23.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-24.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-25.png)

### 写下第一篇博客

前往 `文章-所有文章`，点击 `新增文章`，开始第一次写作吧！

![alt text](https://img.genmin.icu/p/phpblog/image-26.png)

这就是 WordPress 引以为傲的 区块编辑器，在这里你无需了解什么 Markdown 语法，都可以随心随意所见即所得、像编辑一篇 Word 文档一样编辑一篇博客

![alt text](https://img.genmin.icu/p/phpblog/image-27.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-28.png)
...
![alt text](https://img.genmin.icu/p/phpblog/image-29.png)
