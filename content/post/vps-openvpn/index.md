...
date: 2024-01-02
slug: vps-openvpn
image: https://img.genmin.icu/p/vps-openvpn/image.png
categories:
    - Main
    - Linux
---
...
2. 修改 conf 文件，**重点是修改他的路由 route**
    ...
    ![Alt text](https://img.genmin.icu/p/vps-openvpn/image-1.png)
...
2. 写一个 login.conf 文件 (Fron OpenAI)
    ...
    ![Alt text](https://img.genmin.icu/p/vps-openvpn/image-2.png)
...
![Alt text](https://img.genmin.icu/p/vps-openvpn/image-3.png)
