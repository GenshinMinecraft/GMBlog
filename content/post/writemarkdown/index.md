...
正确示范: 
![适当的空格](https://img.genmin.icu/p/writemarkdown/image.png)

错误示范: 
![不适当的空格与大小写](https://img.genmin.icu/p/writemarkdown/image-1.png)
...
![适当的高亮](https://img.genmin.icu/p/writemarkdown/image-2.png)
...
![列表高亮](https://img.genmin.icu/p/writemarkdown/image-3.png)
...
![图片的用法](https://img.genmin.icu/p/writemarkdown/image-4.png)

### 标题的递进

千万，千万不要乱递进标题

![标题错误示范](https://img.genmin.icu/p/writemarkdown/image-5.png)
...
![标点符号](https://img.genmin.icu/p/writemarkdown/image-6.png)
...
![括号的错误实验](https://img.genmin.icu/p/writemarkdown/image-7.png)

上图中的删除线，在不同的 `Markdown 解析器` 中出现了不同的结果:
- VSCode: 可以正常显示删除线
    ![VSCode下划线](https://img.genmin.icu/p/writemarkdown/image-10.png)
- Hexo: 可以正常显示删除线
    ![Hexo删除线](https://img.genmin.icu/p/writemarkdown/image-9.png)
- Hugo: 无法正常显示删除线
    ![Hugo删除线](https://img.genmin.icu/p/writemarkdown/image-8.png)
...
![无序列表](https://img.genmin.icu/p/writemarkdown/image-12.png)

在定义一个有序列表时，建议使用 `数字.` 的形式

正确示范:

![有序列表正确示范](https://img.genmin.icu/p/writemarkdown/image-13.png)

错误示范: 

![有序列表错误示范](https://img.genmin.icu/p/writemarkdown/image-14.png)
...
![引用](https://img.genmin.icu/p/writemarkdown/image-17.png)

请不要简单地使用一个 `Tab` 进行引用，这样的引用会产生歧义

错误示范:

![引用错误示范](https://img.genmin.icu/p/writemarkdown/image-18.png)
