...
![](https://img.genmin.icu/p/cloudflare-tunnel/image-1.png)
在此输入你的*前缀*（喜欢即可，后面可以绑定域名）。

### 选择计划并验卡
![](https://img.genmin.icu/p/cloudflare-tunnel/image-2.png)
在这里选择最左侧的*0刀计划*并继续，随后一路下一步输入自己的卡号信息，即可完成验卡创建。

### 创建第一个隧道
回到[**Zero Trust**的主界面](https://one.dash.cloudflare.com/)
![](https://img.genmin.icu/p/cloudflare-tunnel/image-5.png)

点击左侧的`Access-Tunnels`
![Alt text](https://img.genmin.icu/p/cloudflare-tunnel/image-6.png)

创建Tunnel，点击`Create a tunnel`
![Alt text](https://img.genmin.icu/p/cloudflare-tunnel/image-7.png)
填写名称

按需下载内网穿透的软件
![Alt text](https://img.genmin.icu/p/cloudflare-tunnel/image-8.png)

下一步，填写想*连接的域名*以及tunnel穿透的*协议*与*目标地址*，目标地址可以是本机/内网/公网~~（所以你甚至可以把tunnel当作中转使用）~~
![Alt text](https://img.genmin.icu/p/cloudflare-tunnel/image-9.png)
...
![](https://img.genmin.icu/p/cloudflare-tunnel/image_2023-07-23_21-14-32.png)
