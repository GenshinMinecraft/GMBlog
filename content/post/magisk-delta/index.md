...
date: 2023-07-30
slug: magisk
image: https://img.genmin.icu/p/magisk/222942594-63336f63-6a26-492e-a1d1-a356b5f777b3.png
categories:
    - Main
    - Android
---
...
![Alt text](https://img.genmin.icu/p/magisk/image.png)
...
## 开启Magisk Hide
![](https://img.genmin.icu/p/magisk/image-1.png)

在右上角`设置图标-MagiskHide`中，打开`MagiskHide`与`强制使用超级用户列表`

![](https://img.genmin.icu/p/magisk/image-2.png)

然后重启手机，回到设置中的MagiskHide界面，就可以找到**配置超级用户列表**

![1](https://img.genmin.icu/p/magisk/image-3.png)
