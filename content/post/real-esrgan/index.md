...
date: 2024-05-15
slug: real-esrgan
image: https://img.genmin.icu/p/real-esrgan/image-2.png
categories:
    - Main
    - AI
---
...
![](https://img.genmin.icu/p/real-esrgan/images.jpeg)

超分修复后: (使用 `realesrgan-x4plus` 模型超分)

![](https://img.genmin.icu/p/real-esrgan/images2.jpeg)
...
下载后解压，一般会有以下的文件:
![alt text](https://img.genmin.icu/p/real-esrgan/image-1.png)
